...
const HomeScreen = () => {
  ...
  return (
    <SafeAreaView className="bg-slate-300 flex-1 relative">
      ...
      <View className="px-6 mt-8 space-y-3">
        ...
        <Text className="text-[#3C6072] text-base">
          Consectetur incididunt labore aliqua in reprehenderit tempor consectetur consequat in reprehenderit        
        </Text>
      </View>
